...
<body>
    <div class="container">
    <?php
         $sql = "SELECT title, stories.story_ID FROM stories JOIN accounts_stories ON  accounts_stories.story_ID=stories.story_ID 
                 WHERE accounts_stories.account_ID='$account_id'";
